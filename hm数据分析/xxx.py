...
def plot_distribution():
    ...
    font_14 = FontProperties(fname='C:\Windows\Fonts\msyh.ttc', size=14)
    font_11 = FontProperties(fname='C:\Windows\Fonts\msyh.ttc', size=11)
    ...
    # m.readshapefile('res/china-shapefiles-master/china_prov', 'province', drawbounds=True)
    # m.readshapefile('res/china-shapefiles-master/ne_10m_coastline', 'section', drawbounds=True)
